...
export class CarePlanDataSource extends DataSource<any> {
  constructor(public fhirService : FhirService, public patientId : string,public carePlans : fhir.CarePlan[]
  ) {
  ...
  connect(): Observable<fhir.CarePlan[]> {
    ...
    if (this.patientId != undefined) {
      this.fhirService.getCarePlans(this.patientId).subscribe((bundle => {
